        ...
        <div className="container mx-auto flex justify-between items-center">
          ...
          <nav>
            {isAuthenticated ? (<>
              <button
                onClick={() => {
                  window.location.href = "https://accounts-backend-mexz.onrender.com/admin/";
                }}
                className="bg-yellow-500 hover:bg-yellow-600 text-white font-semibold py-2 px-4 rounded transition duration-300 mr-4"
              >
                Admin Login
              </button>
